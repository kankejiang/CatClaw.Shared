...
public class PressFeedbackBehavior : Behavior<View>
{
    ...
    private async void OnPressed(object? sender, PointerEventArgs e)
    {
        ...
        await Task.WhenAll(
            _view.ScaleToAsync(PressedScale, 80, Easing.CubicOut),
            _view.FadeToAsync(PressedOpacity, 80, Easing.CubicOut));
    }
    ...
    private async void OnReleased(object? sender, PointerEventArgs e)
    {
        ...
        await Task.WhenAll(
            _view.ScaleToAsync(_origScale, 180, Easing.SpringOut),
            _view.FadeToAsync(_origOpacity, 140, Easing.CubicOut));
    }
}
